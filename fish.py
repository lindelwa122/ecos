class Fish:
  ...
  def __setattr__(self, name, value):
    ...
    if name == 'age' and (not isinstance(value, int) or value < 0 or value >= 14):
      raise ValueError(f'The attribute age can only be between 0 and 13 inclusively, {value} received')
  ...
  def __str__(self):
    return f'{"Male" if self.sex else "Female"} Fish (str: {self.strength}, age: {self.age})'
